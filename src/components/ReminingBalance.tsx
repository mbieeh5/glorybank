            ...
            <div className="w-72">
                <h3 className="flex justify-between text-xl">
                    ...
                    <span className="font-bold flex">
                        ...
                        <CountUp from={0} to={state.SaldoBca} separator="," direction="up" duration={1} className="p-1" />,-
                    </span>
                </h3>
                <h3 className="flex justify-between text-xl">
                    ...
                    <span className="font-bold flex">
                        <span className="mr-2">Rp</span>
                        <CountUp from={0} to={state.SaldoBri} separator="," direction="up" duration={1} className="p-1" />,-
                    </span>
                </h3>
                <h3 className="flex justify-between text-xl">
                    ...
                    <span className="font-bold flex">
                        <span className="mr-2">Rp</span>
                        <CountUp from={0} to={state.SaldoDanamon} separator="," direction="up" duration={1} className="p-1" />,-
                    </span>
                </h3>
            </div>
        </div>
